...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/blokirajKorisnika.js"></script>
    ...
    <body>
        ...
        <div>
            <select name="selection" id="odabir" form="carform">
                ...
                <option id="blokirani" selected="selected" name="blokirani" value="blokirani">Blokirani korisnici</option>                
            </select>
        ...
        <br>
        <br>
        <select name="selection" id="odabir2" form="carform">
            <option id="blokiraj" name="blokiraj" value="blokiraj">Blokiraj</option>
            <option id="odblokiraj" selected="selected" name="odblokiraj" value="odblokiraj">Odblokiraj</option> 
        </select>
        <br>
         <input type="text" name="id" id="id" placeholder="Unesite id korisnika" >
         <input name="primjeni" id="primjeni" type="submit" value="Primjeni">
         <br>
